...
export const experience: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Entwicklung einer webbasierten Auswertungsplattform sowie Analyse und automatisierte Datenverarbeitung mit Excel und VBA.",
...
export const projects: Project[] = [
  {
    ...
    description:
      "Vielseitige Desktop-Anwendung für Forschung, Fertigung, Support und Cloud-Engineering mit AWS-API-Integration und Hardware-Schnittstellen.",
  ...
  },
  {
    ...
    description:
      "Weiterentwicklung der bestehenden Apojet App und Entwicklung einer vollständig neuen Android App mit React Native.",
  ...
  },
  {
    ...
    description:
      "Entwicklung einer Webseite mit individueller CMS-Lösung, Verkaufsstellen-Finder und OpenStreetMap-Integration.",
  ...
  },
  {
    ...
    description:
      "Electron-App zur prazisen Steuerung eines Open-Source-6-Achsen-Roboters in Zusammenarbeit mit dem FabLab Darmstadt.",
  ...
  },
  {
    ...
    description:
      "Cross-Plattform-Würfel-App als App-Development-Projekt mit Fokus auf mobile und webbasierte Nutzung.",
  ...
  },
  {
    ...
    description:
      "Im Rahmen eines Bachelorpraktikums entwickelte Anwendung zum dynamischen Senden von Auftragen an industrielle Maschinen mit erweiterbarer Architektur.",
...
export const contactLinks = [
  ...
  { label: "Telefon", value: "+49 159 0245 0748", href: "tel:+4915902450748", icon: "i-mdi-phone" },
  {
    label: "Standort",
    value: "Darmstadt",
    href: "https://www.google.com/maps/place/Darmstadt/",
